...
type Application struct {
	...
	instrumentCollection *mongo.Collection
	variationCollection  *mongo.Collection
}

func NewApplication(prodCollection, userCollection, genreCollection, keyCollection, instrumentCollection, variationCollection *mongo.Collection) *Application {
	return &Application{
